...
class TestContact(unittest.TestCase):
    '''
    Test class that defines test cases for for the contact class behaviours
    ...
    def test_save_multiple_contact(self):
        '''
        test_save_multiple contact to check if we can save multiple contact objects to our contact_list
        '''
    ...
    def test_delete_contact(self):
        '''
        test_delete_contact to test if we can remove a contact from out contact list
        '''
        self.new_contact.save_contact()
        test_contact = Contact("Test", "user", "0712345678",
                               "test@user.com")  # new contact
